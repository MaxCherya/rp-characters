...
export const DeleteScenarioModal: React.FC<DeleteScenarioModalProps> = ({
    ...
    if (!isOpen || !scenarioTitle) return null;

    const normalize = (s: string) => s.replace(/\s+/g, " ").trim().toLowerCase();
    const isMatch =
        confirmationText.trim().length > 0 &&
        normalize(confirmationText) === normalize(scenarioTitle);
        ...
        >
            ...
            >
                ...
                <div className="space-y-3 text-sm text-gray-700">
                    <p>
                        You are about to permanently delete the scenario{" "}
                        <span className="font-semibold">
                            &quot;{scenarioTitle}&quot;
                        </span>
                        . This cannot be undone.
                    </p>
                    <p>To confirm, please type the scenario title exactly:</p>
                </div>
